...
Unpack QF_Cloud_Mask layer, specifically bits 6-7 (Cloud Detection Results & Confidence Indicators), from the NASA's Black Marble VNP46A1/A2 Products.
...
def unpackCloud(num):
    bit = int('{0:016b}'.format(num)[8:-6], 2)
    return bit
...
outputCloud = "./VNP46A2.A2021003.h09v05.001.2021103041024_Cloud_Mask.tif"


temp = "./tempCloud.tif"

## Open HDF file
#band number for QF_Cloud_Mask#
#for VNP46A1, band= 11
#for VNP46A2, band = 5
